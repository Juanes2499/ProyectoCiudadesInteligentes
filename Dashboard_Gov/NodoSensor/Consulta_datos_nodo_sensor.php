                    ...
                    <div class='row'>
                        ...
                        <div class='col-md-6'>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="<?php echo $Num_Nodo; ?>" readonly>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="<?php echo $Longitud; ?>" readonly>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="<?php echo $Latitud; ?>" readonly>
                            </div>
