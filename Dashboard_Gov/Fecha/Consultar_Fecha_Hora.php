...
<div class="card card-danger">
    ...
    <div class="card-body ">
        <form action="Dashboard_Gov_Fecha.php" method="post" name="FH">
            <div class="row align-content-center">
                ...
                <div>
                    <button type="submit" name="ConultarFecha" class="btn btn-success">Realizar consulta</button>
                </div>
            </div>
        </form>
        ...
        <div class="row mt-5">
            <table class="table">
                ...
                <tbody>
                    <?php 
            if(isset($_POST['ConultarFecha'])){
                $year = $_POST['Year'];
                $month = $_POST['Month'];
                $day = $_POST['Day'];
                $h1 = $_POST['H1'];
                $h2 = $_POST['H2'];
                $url = "http://$Host_Sever/api/MySql/GET_JSON_F//$year/$month/$day/H//$h1/$h2";
                $curl = curl_init($url);
...
<div class="card card-danger">
    ...
    <div class="card-body ">
        <form action="Dashboard_Gov_Fecha.php" method="post" name="FH2">
            <div class="row align-content-center">
                Año:
                <div class="col-md-2">
